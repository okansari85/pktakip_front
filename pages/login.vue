      ...
      <div class="login-card">
        ...
        <form @submit.prevent="submit">
          ...
          <div class="form-options">
            <label class="remember"><Checkbox v-model="remember" :binary="true" /><span>Beni hatırla</span></label>
        ...
        <div class="security-box">
          ...
          <div><strong>Yetkili Kullanım</strong><p>Bu sistem yalnızca yetkili kullanıcılar içindir.<br />Tüm erişimler kayıt altına alınmaktadır.</p></div>
        </div>
      </div>
    </section>
  </main>
