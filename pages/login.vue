<template>
  <main class="login-page">
    <section class="login-brand">
      <img src="/pktakip-logo.svg" alt="PKTakip - Periyodik Kontrol Takip" class="brand-logo" />
